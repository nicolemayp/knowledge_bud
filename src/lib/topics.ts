...
export const TOPICS: Topic[] = [
  ...
  { id: "music",          label: "Music therapy",           emoji: "🎶", group: "modality",
    pubmed: clinical(`("music therapy"[mh] OR "music therapy"[tiab] OR "music-based intervention"[tiab]) AND (depression[tiab] OR anxiety[tiab] OR PTSD[tiab] OR autism[tiab] OR dementia[tiab] OR mental health[tiab] OR psychiatric[tiab] OR psychotherapy[tiab] OR trauma[tiab])`) },
  { id: "art",            label: "Art therapy",             emoji: "🎨", group: "modality",
    pubmed: clinical(`("art therapy"[mh] OR "art therapy"[tiab] OR "art-based therapy"[tiab] OR "expressive arts therapy"[tiab]) AND (depression[tiab] OR anxiety[tiab] OR PTSD[tiab] OR trauma[tiab] OR mental health[tiab] OR psychotherapy[tiab] OR psychiatric[tiab])`) },
  { id: "play",           label: "Play therapy",            emoji: "🧸", group: "modality",
    pubmed: clinical(`"play therapy"[tiab] AND (children[tiab] OR adolescent[tiab] OR mental health[tiab] OR trauma[tiab] OR anxiety[tiab] OR depression[tiab] OR psychotherapy[tiab])`) },
  { id: "narrative",      label: "Narrative therapy",       emoji: "📖", group: "modality",
    pubmed: clinical(`("narrative therapy"[tiab] OR "narrative exposure therapy"[tiab]) AND (psychotherapy[tiab] OR mental health[tiab] OR trauma[tiab] OR PTSD[tiab] OR depression[tiab])`) },
  ...
  { id: "ecotherapy",     label: "Ecotherapy / nature",     emoji: "🌳", group: "modality",
    pubmed: clinical(`("ecotherapy"[tiab] OR "nature-based therapy"[tiab] OR "forest bathing"[tiab] OR "wilderness therapy"[tiab] OR "nature exposure"[tiab]) AND (depression[tiab] OR anxiety[tiab] OR mental health[tiab] OR PTSD[tiab] OR psychotherapy[tiab] OR mood[tiab])`) },
